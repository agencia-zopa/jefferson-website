...
Além disso, várias condições médicas podem contribuir para a perda auditiva. Infecções do ouvido, otosclerose, e doenças autoimunes são exemplos de fatores que podem afetar a audição. A identificação precoce e o tratamento adequado dessas condições são essenciais para minimizar os impactos na qualidade de vida dos indivíduos afetados.`,
  ...
  },
  {
    ...
    fullDescription:
      'A otosclerose é uma doença do osso temporal caracterizada por um distúrbio do metabolismo do cálcio resultando em calcificações erráticas, particularmente no estribo. Esse crescimento impede a mobilidade dessas estruturas, resultando em perda auditiva progressiva ou mista. Embora a causa exata da otosclerose não seja totalmente conhecida, fatores genéticos desempenham um papel significativo, com a condição frequentemente ocorrendo em famílias. Os sintomas da otosclerose geralmente começam na idade adulta jovem e podem incluir perda auditiva gradual, zumbido (tinnitus) e, ocasionalmente, vertigem. A perda auditiva tende a ser bilateral, afetando ambos os ouvidos, mas pode ser apenas unilateral. À medida que a doença avança, a perda auditiva pode se tornar significativa, afetando a qualidade de vida e a capacidade de comunicação do indivíduo. O tratamento da otosclerose pode incluir o uso de aparelhos auditivos para amplificar o som ou, em casos selecionados, cirurgia para substituir o estribo afetado por uma prótese, procedimento conhecido como estapedectomia/estapedotomia. Em alguns casos, medicamentos podem ser utilizados para tentar retardar a progressão da doença. A avaliação e o acompanhamento por um otorrinolaringologista são essenciais para o manejo adequado da otosclerose.\n',
    imageUrl: '/patologias/otosclerose.jpg'
  },
  {
    ...
    fullDescription:
      ...
      '\n' +
      'O diagnóstico de otite média aguda é geralmente clínico, baseado na história médica e no exame físico, incluindo a otoscopia, que permite visualizar a inflamação e a presença de fluido no ouvido médio. Uma parte dos casos de otite média aguda resolve-se espontaneamente, mas o tratamento pode incluir analgésicos para alívio da dor e, em casos selecionados, antibióticos para combater a infecção bacteriana.\n' +
      '\n' +
  ...
  },
  {
    ...
    fullDescription:
      'A otite média crônica é uma inflamação persistente ou recorrente do ouvido médio que pode durar várias semanas ou meses. Essa condição pode resultar em danos permanentes às estruturas auditivas, como perfurações timpânicas, retrações timpânicas e erosões da cadeia ossicular. Os sintomas da otite média crônica incluem otorreia (drenagem de líquido pelo ouvido), perda auditiva progressiva e, ocasionalmente, zumbido. A perda auditiva pode variar de leve a severa, dependendo do grau de dano às estruturas auditivas. Em alguns casos, pode ocorrer o desenvolvimento de colesteatoma, o qual pode causar erosão óssea e aumentar o risco de complicações graves. O tratamento da otite média crônica pode incluir a administração de antibióticos tópicos ou sistêmicos, limpeza do ouvido e, frequentemente, cirurgia para remover a doença e reconstruir as estruturas danificadas. Procedimentos como a timpanoplastia ou a timpanomastoidectomia podem ser necessários para restaurar a integridade do ouvido médio e prevenir complicações futuras. O acompanhamento regular com um otorrinolaringologista é crucial para o manejo eficaz dessa condição.',
  ...
  },
  {
    ...
    fullDescription:
      'O colesteatoma é um crescimento anormal de tecido epitelial na orelha média e mastoide que pode causar erosão óssea, infecções recorrentes e perda auditiva progressiva se não for tratado. Esse tecido anômalo pode exercer pressão sobre as estruturas circundantes, levando a complicações graves, incluindo destruição óssea e até extensão para áreas próximas, como o ouvido interno e a base do crânio. Os sintomas de um colesteatoma incluem secreção crônica pelo ouvido (otorreia), perda auditiva e, em casos avançados, vertigem e paralisia facial. Na otoscopia identificamos a presença do colesteatoma e exames de imagem como tomografia computadorizada (TC) e eventualmente ressonância magnética (RNM) são utilizados para avaliar a extensão do colesteatoma e o envolvimento das estruturas ósseas. O tratamento do colesteatoma é eminentemente cirúrgico, visando a remoção completa da doença para prevenir a recorrência e evitar suas complicações. A timpanomastoidectomia é o procedimento mais frequentemente realizado nesses casos. O acompanhamento pós-operatório é essencial para monitorar a cicatrização e identificar quaisquer sinais de recorrência. O manejo eficaz do colesteatoma é crucial para preservar a audição e prevenir complicações graves.',
