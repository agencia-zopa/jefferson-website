...
export default function Home() {
  return (
    <>
      ...
      <InitialSection />
      <PresentationSection />
      <SpecialtySection imageSrc={otologiaImage} imageAlt="Dr. Jefferson segurando a cabeça de uma paciente" title="Otologia" articleHref="#">
        A Otologia é uma especialidade médica focada no estudo e tratamento dos distúrbios do ouvido e suas estruturas relacionadas. Isso inclui não apenas o ouvido externo e médio, mas também o ouvido interno e as conexões neurais que transmitem informações auditivas ao cérebro.
      </SpecialtySection>
