  ...
  const addresses: Address[] = [
    {
      ...
      description: (
        <span>
          ...
          - RS, <span className={styles.noWrap}>90440-011</span>
        </span>
      )
    },
    {
      ...
      description: (
        <span>
          Av. Sen. Tarso Dutra, 10 - 3º Andar - Petrópolis, Porto Alegre - RS,{' '}
          <span className={styles.noWrap}>90690-140</span>
        </span>
      )
    },
    {
      ...
      description: (
        <span>
          R. Liberdade, 33 - Mal. Rondon, Canoas - RS,{' '}
          <span className={styles.noWrap}>92020-030</span>
        </span>
      )
    },
    {
      ...
      description: (
        <span>
          De Segunda À Sexta Das 08:00 às 19h00.{' '}
          <span className={`${styles.noWrap} ${styles.bold}`}>
            (51) 99152-6125
          </span>
        </span>
      )
